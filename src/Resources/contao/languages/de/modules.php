...
$GLOBALS['TL_LANG']['MOD']['bluebranch_chatbot'] = 'BlueBranch Chatbot';
$GLOBALS['TL_LANG']['MOD']['chatbot_trained_content'] = ['Trainierte Seiten', 'Hier sehen Sie alle für den Chatbot trainierten Inhalte.'];
